...
<Steps>
    ...
    Next, add the `admin-portal` app to the project using the `bootstrap-app` command

    ```shell
    cd my_superapp;
    cd superapp/apps;
    django_superapp bootstrap-app \
        --template-repo https://github.com/django-superapp/django-superapp-admin-portal ./admin-portal;
    cd ../../;
    ```
