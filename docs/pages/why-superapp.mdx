...
## Why SuperApp?
SuperApp is better way to organize your Django projects by splitting them into multiple individual apps. Each app has its own `settings.py` and `urls.py` files, which will be imported automatically by the system.
