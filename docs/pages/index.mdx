...
**SuperApp** is an extension of Django by letting developers split their projects into multiple individual apps, each app having its own `settings.py` and `urls.py` files, which will be imported automatically by the system.
